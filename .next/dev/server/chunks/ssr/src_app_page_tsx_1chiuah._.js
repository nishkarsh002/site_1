...
function Page() {
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].to(pObj, {
            n: 100,
            duration: 1.5,
            ease: "power2.inOut",
            onUpdate () {
        ...
        function bootSite() {
            ...
            /* Lenis */ if (typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lenis$2f$dist$2f$lenis$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"] !== "undefined") {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].ticker.add((t)=>lenis.raf(t * 1000));
            ...
            // });
            /* counters */ document.querySelectorAll(".count").forEach((el)=>{
        ...
        /* ---------- Hero showcase slider ---------- */ function initShow() {
            const slides = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].utils.toArray("#showSlider .show-slide");
            const dots = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].utils.toArray("#showDots .show-dot");
        ...
        /* ---------- Testimonial slider ---------- */ function initTSlider() {
            const slides = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].utils.toArray(".tsl");
            const dots = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].utils.toArray("#tsDots .tsl-dot");
            let i = 0, timer;
            const LEN = slides.length;
            function go(next) {
                slides[i].classList.remove("active");
            ...
            function restart() {
                if (timer) clearInterval(timer);
                if (!reduce) timer = setInterval(()=>go(i + 1), 6500);
            }
        ...
        /* ---------- Blog slider ---------- */ function initBlog() {
            ...
            document.getElementById("blogNext").addEventListener("click", ()=>scroller.scrollBy({
                    left: step(),
                    behavior: "smooth"
                }));
            document.getElementById("blogPrev").addEventListener("click", ()=>scroller.scrollBy({
                    left: -step(),
                    behavior: "smooth"
                }));
        }
        ...
        /* ---------- Magnetic squares ---------- */ function initMagnetic() {
            ...
            document.querySelectorAll(".btn-square, a[data-cursor='hover']").forEach((el)=>{
                ...
                el.addEventListener("mouseleave", ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].to(el, {
                        x: 0,
                        y: 0,
                        duration: .6,
